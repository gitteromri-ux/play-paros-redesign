...
function renderStrategy() {
  ...
  <section class="wrap">
    ...
    <div class="split reveal" style="margin-top:var(--space-10)">
      ...
      <div>
        <p class="body-copy"><strong>Fixed, not invented:</strong> room copy now says "Double Bed" consistently. Today's real facilities are told honestly — the actual beach bar is a hero facility, the neighboring breakfast partner is a "Neighborhood Breakfast" story, not hidden.</p>
        <p class="body-copy" style="margin-top:var(--space-4)"><strong>The one deliberate exception: KATO.</strong> The homepage's F&amp;B section mocks up the branded in-house programme this pitch recommends — Rooftop, Breakfast Table, Beach — clearly framed as "the opportunity" and "mock-up," not as an existing facility. This is the one place the site shows the dream instead of the audit, because a Leon meeting about F&amp;B needs to see the destination, not just the gap.</p>
  ...
  <section class="wrap">
    ...
    <p class="lede" style="margin-top:var(--space-6); max-width:78ch">Give us Play Paros as the pilot — the smallest, cleanest asset, already proving demand with a <strong>10.0 breakfast score</strong> on an outsourced product <a href="https://www.booking.com/hotel/gr/play-paros.html" target="_blank" rel="noopener noreferrer" style="text-decoration:underline">(Booking.com)</a>. We bring <strong>KATO</strong> — the branded rooftop, breakfast and beach programme mocked up on the homepage — in-house, fix the review-generation gap, and show a measurable score and revenue move before the <strong>Q4 2026 call-option window</strong> closes <a href="https://www.deeptase.co.il/en/analysis/2049" target="_blank" rel="noopener noreferrer" style="text-decoration:underline">(DeepTASE)</a>. If it works at 40 rooms, it's the reference case for Corinthia, Chalkida, and the Brown Hospitality Management sales deck itself.</p>
